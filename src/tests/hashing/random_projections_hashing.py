...
class RandomProjectionHashingTests(unittest.TestCase):
    ...
    def test_wrong_data_dim_should_throw_error(self):
        hashing = RandomProjectionStateHashing(3, 2, scale_factors=5, device="cpu")
        x = torch.randn(100, 3)
    ...
    def test_that_similar_items_have_same_hash(self):
        hashing = RandomProjectionStateHashing(3, 2, scale_factors=3, device="cpu")
    ...
    def test_dimension_reduction(self):
        ...
        n_dim = 10
        n_hashes = 6
        hashing = RandomProjectionStateHashing(n_hashes, n_dim, scale_factors=5, device="cpu")
    ...
    def test_grouping_visual_test(self):
        ...
        n_dim = 2
        n_hashes = 15
        hashing = RandomProjectionStateHashing(n_hashes, n_dim, scale_factors=10, device="cpu")
